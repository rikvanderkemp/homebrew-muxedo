...
class Muxedo < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "dea244f42434226d308db6f72bfa375cc113bc8ac598b9005b6a8696e55bc591"
    else
      url "https://github.com/rikvanderkemp/muxedo/releases/download/v#{version}/muxedo_#{version}_darwin_amd64.tar.gz"
      sha256 "1a744dc292a8c5b17f3eb8c99cf612b8439ad0f8aae985f6575c217b6bc996d4"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "d1d883d8140300d9328019039617d8061cd2410eadff0ff6cad01b1fcf3c5f0b"
    else
      url "https://github.com/rikvanderkemp/muxedo/releases/download/v#{version}/muxedo_#{version}_linux_amd64.tar.gz"
      sha256 "a44ab3b6bcaf556794f4815812007e54f5b387c417b64eb8541ff590cb237029"
    end
  end
